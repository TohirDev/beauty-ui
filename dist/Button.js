...
export var Button = function (_a) {
    var variant = _a.variant, children = _a.children, customStyle = _a.customStyle;
    return (_jsx(StyledButton, { variant: variant, customStyle: customStyle, children: children }));
};
